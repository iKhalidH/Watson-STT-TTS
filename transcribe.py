...
# authenticator = IAMAuthenticator('L4JXRE1CmjXLmOy4Lpc6nuL9euztY5Cahbt6PUougRsk')
# text_to_speech = TextToSpeechV1(
#    authenticator=authenticator
# )

#text_to_speech.set_service_url('https://api.us-south.speech-to-text.watson.cloud.ibm.com/instances/0e519019-a1d9-436f-a09a-133d33dfb03c')
...
apikey = "B349Tc1exFYXu7RSpAHRXGU9pKE7QYSx-ZaEn2jeAbg-"
url = "https://api.us-south.text-to-speech.watson.cloud.ibm.com/instances/5ad7fa7e-d24b-4959-9bd1-aa40db9b7691"
#setup service
...
#this is chatbot authenticator
authenticator = IAMAuthenticator('L4JXRE1CmjXLmOy4Lpc6nuL9euztY5Cahbt6PUougRsk')
assistant = AssistantV2(
version='2021-07-29',
authenticator=authenticator
)
assistant.set_service_url('https://api.eu-de.assistant.watson.cloud.ibm.com/instances/2af20519-18fc-4124-a5a2-69b45f22597a')
...
def read_audio(ws, timeout):
    ...
    assistant_id='9bf02a0b-09cc-4401-9377-dc894e6d4568',
    input={
        'message_type': 'text',
        'text': txt
    }
